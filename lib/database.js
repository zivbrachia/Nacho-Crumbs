...
module.exports = {
    ...
    updateUserAddress, getChapters, queryQuestions, getUserData, getQuestionsByChapter, getAddressByUserId};
...
function getAddressByUserId(source, userId, callback) {
    ref.child('users').child(source).child(userId).once("value", function(snapshot) {
