...
function chatFlow1(connObj, response, userData, source) {
    ...
    if (isFollowUpWrong(response.result.action)) {
        ...
        userData.study_session.questions.push(userData.question.intentName);
    }
...
function getNextQuestion(current_question) {
    ...
    let questions = {
        ...
        Question_Ask_138 : 'Information_101',
        Information_101 : 'Question_Ask_139',
        //Information_101 : 'Session_1_Break',    /* Day 1 */
        ...
        Question_Ask_143 : 'Information_103',
        Information_103 : 'Question_Ask_144',
        //Information_103 : 'Session_1_Break',    /* Day 2 */
        ...
        Question_Ask_148 : 'Information_104',
        Information_104 : 'Question_Ask_149',
        //Information_104 : 'Session_1_Break',    /* Day 3 */
