...
function is_answer_correct(session, answer) {
    ...
    for (let i = 0; i < session.userData.current_question.choices.length; i++) {
        console.log("session.userData.current_question.choices[" + i + "]",
            [session.userData.current_question.choices[i].title,
                answer,
            session.userData.current_question.choices[i].title === answer,
            session.userData.current_question.choices[i].payload === answer,
            session.userData.current_question.choices[i].isCorrect === true,
            session.userData.current_question.choices[i].isCorrect === false,
            (((session.userData.current_question.choices[i].title === answer) || (session.userData.current_question.choices[i].payload === answer)) && (session.userData.current_question.choices[i].isCorrect === true)),
            (((session.userData.current_question.choices[i].title === answer) || (session.userData.current_question.choices[i].payload === answer)) && (session.userData.current_question.choices[i].isCorrect === false))
            ]);
