...
function getMessage(address, message, builder, textData, messageIndex) {
    ...
    switch (message.type) {
        case 0:
            ...
            break;
        case 1:
            msg.msg = getMessageTypeCard(address, builder, messageIndex);
            break;
        case 2:
...
function getMessageTypeCard(address, builder, messageIndex) {
    let msg = {};
    if (address.channelId==='facebook') {
        msg = getMessageTypeCustomPayload(address, facebook.cardJson(response, messageIndex), builder);
    }
